...
bot.connection_url.pw = os.environ["password"]
bot.connection_url = "mongodb+srv://sonofthebae:<password>@cluster0.wrcss.mongodb.net/<dbname>?retryWrites=true&w=majority"
